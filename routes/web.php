...
Route::group(['middleware' => ['auth']], function () {
    ...
    /* --------------------------------------- Rotas despesa parcelada ---------------------------------------------------------------*/
    Route::post('/despesa/parcelada', [DespesaParceladaController::class, 'create'])->name('despesaParcelada');
    Route::get('/despesa/parcelada', [DespesaParceladaController::class, 'index'])->name('despesaParcelada');
    Route::put('/despesa/parcelada', [DespesaParceladaController::class, 'update'])->name('despesaParcelada');
    Route::delete('/despesa/parcelada/{id}', [DespesaParceladaController::class, 'delete'])->name('deleteDespesaParcelada');

    /* Arquivos despesas parceladas */
    Route::post('/file/despesaParcelada/', [ArquivoDespesaRecorrenteController::class, 'create']); // Anexa o arquivo da despesa recorrente;
    Route::get('/file/despesaParcelada/{id}', [ArquivoDespesaRecorrenteController::class, 'get']); // Lista todos os arquivos respectivos à despesa;
    Route::get('/file/despesaParcelada/view/{id}', [ArquivoDespesaRecorrenteController::class, 'viewFile']); // Abre o arquivo;
    Route::get('/file/despesaParcelada/download/{id}', [ArquivoDespesaRecorrenteController::class, 'downloadFile']); // Faz o download do arquivo;
    Route::put('/file/despesaParcelada/', [ArquivoDespesaRecorrenteController::class, 'update']); // Altera o tipo do arquivo;
    Route::delete('/file/despesaParcelada/', [ArquivoDespesaRecorrenteController::class, 'delete']); // Remove o arquivo do aws e do banco de dados;
});
